...
{variant:4,5}IncreasedAttackSpeedUniqueShieldDex6
...
{variant:1}LocalIncreaseSocketedGemLevelUniqueSceptre1
...
{variant:3}MutatedUniqueRing34GainPowerChargeOnKillingFrozenEnemy
