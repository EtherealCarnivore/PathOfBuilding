...
{variant:1,2}50000% chance to Avoid being Frozen
...
{variant:1}5000% chance to create Shocked Ground when Hit
{variant:1}10000% chance to Curse non-Cursed Enemies with a random Hex on Hit
...
{variant:1,2}Gain an Endurance Charge when you Block
